...
<head>
    ...
    <title><?php echo e($product->name); ?> - Casio Store</title>
    ...
    <main class="container my-5">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-truncate" aria-current="page"><?php echo e($product->name); ?></li>
            </ol>
        </nav>
        ...
        <div class="row g-5">
            <div class="col-lg-6">
                <div class="product-gallery shadow-sm">
                    <img src="https://loremflickr.com/800/800/watch?lock=<?php echo e($product->id); ?>" alt="<?php echo e($product->name); ?>" class="main-img">
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="ps-lg-3">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="price-tag me-3"><?php echo e(number_format($product->price)); ?>đ</div>
                        <div class="text-muted text-decoration-line-through"><?php echo e(number_format($product->price * 1.2)); ?>đ</div>
                    </div>
                    ...
                    <div class="row g-3 mb-5">
                        <div class="col-md-8">
                            <a href="/add-to-cart/<?php echo e($product->id); ?>" class="btn btn-add-large w-100 fs-5">
               ...
               <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-md-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                        <img src="https://loremflickr.com/300/300/watch?lock=<?php echo e($rp->id); ?>" class="card-img-top p-2" alt="...">
                        <div class="card-body text-center">
                            <h6 class="fw-bold text-truncate"><?php echo e($rp->name); ?></h6>
                            <p class="text-danger fw-bold small"><?php echo e(number_format($rp->price)); ?>đ</p>
                            <a href="/product/<?php echo e($rp->id); ?>" class="btn btn-sm btn-outline-primary w-100 rounded-3">Xem ngay</a>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\shopdongho\resources\views/detail.blade.php ENDPATH**/ ?>