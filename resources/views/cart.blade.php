            ...
            @foreach($cart as $id => $item)
                ...
                <div class="cart-item">
                    ...
                    <div style="flex:1;">
                        ...
                        <div class="cart-price">{{ number_format($item['price']) }} đ</div>
                    </div>

                    <!-- SỐ LƯỢNG -->
                    <div class="qty-box">
                        <a href="/decrease/{{ $id }}" class="qty-btn">-</a>
                        <div class="qty-number">{{ $item['quantity'] }}</div>
                        <a href="/increase/{{ $id }}" class="qty-btn">+</a>
                    </div>
                    ...
                    <!-- XOÁ -->
                    <a href="/remove/{{ $id }}" class="btn btn-sm btn-outline-danger">
                        ✕
                    </a>
